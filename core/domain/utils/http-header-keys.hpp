...
public:
    ...
    typedef std::unordered_map<Name, Map::const_iterator> RevMapConst;
    typedef std::unordered_map<Name, Map::iterator> RevMap;
    ...
    // mapped to thier actual values
    static const inline Map ToNamedKeys{
        {"accept", ACCEPT},
        {"accept-ch", ACCEPT_CH},
    ...
    static const inline strv RawValueByNamedKey(Name n)
    {
        static RevMapConst namedKeys;
        if (namedKeys.size() == 0)
        {
            for (auto it = ToNamedKeys.begin(); it != ToNamedKeys.end(); it++)
                namedKeys[it->second] = it;
        }

        auto it = namedKeys.find(n);
        if (it == namedKeys.end())
            return "";
        else
    ...
    static const inline std::unordered_set<Name> REQUEST_HEADER_KEYS{ACCEPT, ACCEPT_CH, ACCEPT_ENCODING, ACCEPT_LANGUAGE, ACCEPT_PATCH, ACCEPT_POST, ACCEPT_RANGES, ACCESS_CONTROL_ALLOW_CREDENTIALS, ACCESS_CONTROL_ALLOW_HEADERS, ACCESS_CONTROL_ALLOW_METHODS, ACCESS_CONTROL_ALLOW_ORIGIN, ACCESS_CONTROL_EXPOSE_HEADERS, ACCESS_CONTROL_MAX_AGE, ACCESS_CONTROL_REQUEST_HEADERS, ACCESS_CONTROL_REQUEST_METHOD, ACTIVATE_STORAGE_ACCESS, AGE, ALLOW, ALT_SVC, ALT_USED, AUTHORIZATION, CACHE_CONTROL, CLEAR_SITE_DATA, CONNECTION, CONTENT_DIGEST, CONTENT_DISPOSITION, CONTENT_ENCODING, CONTENT_LANGUAGE, CONTENT_LENGTH, CONTENT_LOCATION, CONTENT_RANGE, CONTENT_SECURITY_POLICY, CONTENT_SECURITY_POLICY_REPORT_ONLY, CONTENT_TYPE, COOKIE, CROSS_ORIGIN_EMBEDDER_POLICY, CROSS_ORIGIN_EMBEDDER_POLICY_REPORT_ONLY, CROSS_ORIGIN_OPENER_POLICY, CROSS_ORIGIN_RESOURCE_POLICY, DATE, ETAG, EXPECT, EXPIRES, FORWARDED, FROM, HOST, IF_MATCH, IF_MODIFIED_SINCE, IF_NONE_MATCH, IF_RANGE, IF_UNMODIFIED_SINCE, INTEGRITY_POLICY, INTEGRITY_POLICY_REPORT_ONLY, KEEP_ALIVE, LAST_MODIFIED, LINK, LOCATION, MAX_FORWARDS, ORIGIN, ORIGIN_AGENT_CLUSTER, PREFER, PREFERENCE_APPLIED, PRIORITY, PROXY_AUTHENTICATE, PROXY_AUTHORIZATION, RANGE, REFERER, REFERRER_POLICY, REFRESH, REPORTING_ENDPOINTS, REPR_DIGEST, RETRY_AFTER, SEC_FETCH_DEST, SEC_FETCH_MODE, SEC_FETCH_SITE, SEC_FETCH_STORAGE_ACCESS, SEC_FETCH_USER, SEC_PURPOSE, SEC_WEBSOCKET_ACCEPT, SEC_WEBSOCKET_EXTENSIONS, SEC_WEBSOCKET_KEY, SEC_WEBSOCKET_PROTOCOL, SEC_WEBSOCKET_VERSION, SERVER, SERVER_TIMING, SERVICE_WORKER, SERVICE_WORKER_ALLOWED, SERVICE_WORKER_NAVIGATION_PRELOAD, SET_COOKIE, SET_LOGIN, SOURCEMAP, STRICT_TRANSPORT_SECURITY, TE, TIMING_ALLOW_ORIGIN, TRAILER, TRANSFER_ENCODING, UPGRADE, UPGRADE_INSECURE_REQUESTS, USER_AGENT, VARY, VIA, WANT_CONTENT_DIGEST, WANT_REPR_DIGEST, WWW_AUTHENTICATE, X_CONTENT_TYPE_OPTIONS, X_FRAME_OPTIONS};

    static const inline std::unordered_set<Name> RESPONSE_HEADER_KEYS{ACCEPT, ACCEPT_CH, ACCEPT_ENCODING, ACCEPT_LANGUAGE, ACCEPT_PATCH, ACCEPT_POST, ACCEPT_RANGES, ACCESS_CONTROL_ALLOW_CREDENTIALS, ACCESS_CONTROL_ALLOW_HEADERS, ACCESS_CONTROL_ALLOW_METHODS, ACCESS_CONTROL_ALLOW_ORIGIN, ACCESS_CONTROL_EXPOSE_HEADERS, ACCESS_CONTROL_MAX_AGE, ACCESS_CONTROL_REQUEST_HEADERS, ACCESS_CONTROL_REQUEST_METHOD, ACTIVATE_STORAGE_ACCESS, AGE, ALLOW, ALT_SVC, ALT_USED, AUTHORIZATION, CACHE_CONTROL, CLEAR_SITE_DATA, CONNECTION, CONTENT_DIGEST, CONTENT_DISPOSITION, CONTENT_ENCODING, CONTENT_LANGUAGE, CONTENT_LENGTH, CONTENT_LOCATION, CONTENT_RANGE, CONTENT_SECURITY_POLICY, CONTENT_SECURITY_POLICY_REPORT_ONLY, CONTENT_TYPE, COOKIE, CROSS_ORIGIN_EMBEDDER_POLICY, CROSS_ORIGIN_EMBEDDER_POLICY_REPORT_ONLY, CROSS_ORIGIN_OPENER_POLICY, CROSS_ORIGIN_RESOURCE_POLICY, DATE, ETAG, EXPECT, EXPIRES, FORWARDED, FROM, HOST, IF_MATCH, IF_MODIFIED_SINCE, IF_NONE_MATCH, IF_RANGE, IF_UNMODIFIED_SINCE, INTEGRITY_POLICY, INTEGRITY_POLICY_REPORT_ONLY, KEEP_ALIVE, LAST_MODIFIED, LINK, LOCATION, MAX_FORWARDS, ORIGIN, ORIGIN_AGENT_CLUSTER, PREFER, PREFERENCE_APPLIED, PRIORITY, PROXY_AUTHENTICATE, PROXY_AUTHORIZATION, RANGE, REFERER, REFERRER_POLICY, REFRESH, REPORTING_ENDPOINTS, REPR_DIGEST, RETRY_AFTER, SEC_FETCH_DEST, SEC_FETCH_MODE, SEC_FETCH_SITE, SEC_FETCH_STORAGE_ACCESS, SEC_FETCH_USER, SEC_PURPOSE, SEC_WEBSOCKET_ACCEPT, SEC_WEBSOCKET_EXTENSIONS, SEC_WEBSOCKET_KEY, SEC_WEBSOCKET_PROTOCOL, SEC_WEBSOCKET_VERSION, SERVER, SERVER_TIMING, SERVICE_WORKER, SERVICE_WORKER_ALLOWED, SERVICE_WORKER_NAVIGATION_PRELOAD, SET_COOKIE, SET_LOGIN, SOURCEMAP, STRICT_TRANSPORT_SECURITY, TE, TIMING_ALLOW_ORIGIN, TRAILER, TRANSFER_ENCODING, UPGRADE, UPGRADE_INSECURE_REQUESTS, USER_AGENT, VARY, VIA, WANT_CONTENT_DIGEST, WANT_REPR_DIGEST, WWW_AUTHENTICATE, X_CONTENT_TYPE_OPTIONS, X_FRAME_OPTIONS};
